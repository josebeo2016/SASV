...
class SSLModel(nn.Module):
    def __init__(self,device='cpu', num_layers=24, order='first', custom_order=None, pretrained_path='pretrained/xlsr2_300m.pt'):
        ...
        cp_path = os.path.join(BASE_DIR, pretrained_path)
...
if __name__ == '__main__':
    model = SSLModel()
    input_data = torch.randn(2, 16000)
